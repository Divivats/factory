...
import { X, FileText, Cpu, Wifi, Activity, FileCode, Trash2 } from 'lucide-react'
...
export default function PCDetailsModal({ pcSummary, onClose, onPCDeleted }: Props) {
  ...
  // Config upload handler removed - only download is supported
  ...
  return (
    <>
      ...
      {/* Upload modal removed - config upload not supported */}
